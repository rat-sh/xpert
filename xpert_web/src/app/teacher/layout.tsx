...
import { CalendarDays, FileText, ClipboardList, LogOut, Menu, Users, BookOpen, Archive, X, User } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { ThemeToggle } from '@/app/components/ui/ThemeToggle';

const tabs = [
  { id: 'calendar', label: 'Calendar', icon: CalendarDays, href: '/teacher/calendar' },
  { id: 'exams', label: 'Create Exam', icon: ClipboardList, href: '/teacher/exams' },
